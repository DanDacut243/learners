...
export function meta() {
  return [{ title: "ERUDITE - Messages & Inbox" }];
}
...
export default function StudentInbox() {
  ...
  async function handleSendReply() {
    ...
    try {
      ...
      const recipientName = selectedMessage.sender?.name || "Instructor";
          ...
          <div className="flex-1 overflow-y-auto divide-y divide-slate-100">
            {messages.length === 0 ? (
              <div className="p-6 text-center text-slate-500">
                ...
                <p>No messages yet</p>
                <p className="text-xs mt-2">Instructors will message you here</p>
              </div>
            ) : (
              messages.map((msg) => (
                <div
            ...
            <div className="p-4 border-b border-slate-100 flex justify-between items-start">
              <div className="flex-1">
                ...
                <h3 className="text-lg font-bold text-primary">
                  {selectedMessage.sender?.name || "Instructor"}
                </h3>
