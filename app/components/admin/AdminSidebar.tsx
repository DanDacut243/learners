...
const NAV_ITEMS = [
  ...
  { href: "/admin/catalog", icon: "library_books", label: "Academic Catalog" },
...
export function AdminSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 z-50 bg-slate-100 flex flex-col py-8 px-4">
      ...
      <div className="px-4 mb-8 text-[10px] font-manrope font-bold text-slate-500 uppercase tracking-[0.2em]">Admin Console</div>
